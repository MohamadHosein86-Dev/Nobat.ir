                     ...
                     <Modal>
                        <Modal.Open openwindowName="s">
                         <div className=" relative">
                            {!isTodayAcsepting?.includes(res.day) && <span className=" bg-[red] text-[#fff] absolute w-[7rem] pr-[1.5rem] text-[.7rem] p-[.4rem]  font-bold rounded-[.5rem] ">نوبت دهی ندارد</span>}  
