  ...
  return (
    <section className=" w-full">
     <div className="  max-w-[68rem] mx-auto  px-[1.5rem] py-[1rem] md:px-[4rem] md:py-[2rem]">
       <h1 className=" sm:text-right md:mb-[3.2rem] md:mt-[-.8rem] text-center text-[1.3rem] sm:text-[1.3rem] font-medium text-[#044c6a] mb-[1.2rem] mt-[1rem]"> { (city || specialties ) &&` لیست آدرس و تلفن ، پزشکان ${specialty == null ? "" : specialty}  ${city === null ? "" :city} ` }</h1> 
