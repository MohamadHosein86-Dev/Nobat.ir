       ...
       <div className=" flex gap-[8rem]">
           ...
           <div>
                <ul className=" flex flex-wrap gap-[1rem]">{doctors?.map((res)=>
                   <li className=" border-[1px] border-solid border-[#ececec] flex justify-between w-[22rem] px-[1rem] py-[.5rem] h-[9rem]" key={res.id}>
                    <div className=" flex flex-col ">
                    <h2 className=" text-sm font-semibold">{res.name}</h2>
                      <p className=" bg-[#f8feff] text-[#004d6c] mb-[2rem] mt-[1rem] p-[2px] max-w-fit">{res.specialty}</p>
