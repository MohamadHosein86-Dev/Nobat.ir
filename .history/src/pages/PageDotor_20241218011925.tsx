                     ...
                     <Modal>
                        <Modal.Open openwindowName="s">
                         <div className=" relative">
                            ...
                            <button onClick={()=>setShowModal((res)=>res!)} style={{minWidth: "7rem"}} key={res.day} 
                            className={` cursor-pointer ${isTodayAcsepting?.includes(res.day)  ? "bg-[#f9ffea]" : "bg-[#eee] text-[#aaa]"  } flex flex-col justify-center font-semibold items-center border-[1px] rounded-[10px] border-[#75950c] text-[#75950c] w-[7rem] h-[7.5rem] `}>
                                <span> {res.day} </span>
