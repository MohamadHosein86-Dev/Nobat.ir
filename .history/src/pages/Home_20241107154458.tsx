       ...
       <div className=" flex gap-[8rem]">
           ...
           <div>
                <ul className=" flex flex-wrap gap-[1rem]">{doctors?.map((res)=>
                   <li className=" border-[1px] border-solid border-[#ececec] flex justify-between w-[22rem] px-[1rem] py-[.5rem] h-[10rem]" key={res.id}>
                    <div className=" flex flex-col ">
                       <div>
                       <h2 className=" text-lg font-semibold">{res.name}</h2>
                        <p className=" bg-[#f8feff] text-[#004d6c] mb-[2.5rem] mt-[1rem] p-[2px] max-w-fit">{res.specialty}</p>
