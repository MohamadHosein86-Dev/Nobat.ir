  ...
  return (
    <section className=" w-full">
     <div className="  max-w-[68rem] mx-auto  px-[1.5rem] py-[1rem] md:px-[4rem] md:py-[2rem]">
       <h1 className=" text-center text-[1.5rem] font-semibold text-[#044c6a] mb-[1.2rem] mt-[1.5rem]">{specialty || city !== null && ` لیست آدرس و تلفن ، پزشکان ${specialty == null ? "" : specialty} ، ${city === null ? "" :city} ` }</h1>
