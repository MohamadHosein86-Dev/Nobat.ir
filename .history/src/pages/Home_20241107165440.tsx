       ...
       <div className=" flex gap-[8rem]">
           ...
           <div>
                <ul className=" flex flex-wrap gap-[1rem]">{doctors?.map((res)=>
                   ...
                   <li className=" border-[1px] border-solid border-[#ececec] flex flex-col justify-between w-[22rem] px-[1rem] py-[.5rem] h-[11rem]" key={res.id}>
                    <div className=" flex justify-between ">
                       <div className=" flex flex-col">
                        <div>
                          <h2 className=" text-lg font-semibold pt-[.5rem]">{res.name}</h2>
                           <p className=" bg-[#f8feff] text-[#004d6c] mt-[1.2rem]  max-w-fit">متخصص {res.specialty}</p>
                        </div>
                      ...
                      <div className=" flex justify-between items-center mb-[.25rem]">
                        <p className=" text-[#878787]">{lenghfWords(res.address , 3)}</p>
                        <p> <span className="  text-sm font-semibold">120 نفر </span> ⭐⭐⭐⭐</p>
                      </div>
                   </li>
