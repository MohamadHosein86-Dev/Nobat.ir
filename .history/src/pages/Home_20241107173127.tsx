       ...
       <div className=" w-[100%] flex gap-[2.8rem] ">
           <div>
              <ul className=" mr-[1.2rem] w-[11rem]">
                {specialties.map((res)=> <li key={res} className=" cursor-pointer hover:text-[#363636] list-disc mb-[1rem] text-[#363636ab] hover:font-semibold">{res}</li>)}
              </ul>
           </div>
           <div>
                       ...
                       <div className=" flex flex-col">
                        <div>
                          <h2 className=" text-lg font-semibold pt-[.5rem]">{res.name}</h2>
                           ...
                           {res.accepting_patients && <> <span className=" text-[.7rem] font-semibold text-[#bababa] ml-[.4rem]">نوبت دهی  </span> <span className=" flex justify-center items-center rounded-[4px] px-[.4rem] py-[.1rem] text-[.8rem]  bg-[#75950c15]   text-[#75950cb3]"> اینترنتی</span></>}
                        </div>
