                       ...
                       <div className=" flex flex-col">
                        <div>
                          <h2 className=" text-lg font-semibold pt-[.5rem]">{res.name}</h2>
                           ...
                           {res.accepting_patients && <> <span className=" text-[.7rem] font-semibold text-[#bababa] ml-[.4rem]">نوبت دهی  </span> <span className="  rounded-[4px] px-[.4rem] py-[.1rem] text-[.8rem]  bg-[#75950c15]   text-[#75950cb3]"> اینترنتی</span></>}
                        </div>
