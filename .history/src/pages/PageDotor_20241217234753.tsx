    ...
    <section className="">
      ...
      <div className="  max-w-[68rem] mx-auto  px-[1.5rem]  py-[1rem] flex-col   md:px-[4rem] md:py-[2rem]">
       ...
       <div className="flex-col lg:flex-row flex justify-between  ">
            <div className=" ">
                  <div className="relative flex gap-[1.5rem] overflow-x-auto mt-[1rem] justify-center">
                    ...
                    doctor?.working_hours.map((res)=>
                     <Modal>
                        <Modal.Open openwindowName="s">
                         <div >
                            {!isTodayAcsepting?.includes(res.day) && <span className=" absolute top-[1rem]">نوبت دهی ندارد</span>}  
