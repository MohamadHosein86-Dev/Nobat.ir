  ...
  return (
    <section className=" flex justify-center  w-[100%] h-[100%]">
        <form onSubmit={handleLogin} className=" flex flex-col w-[20rem] h-[100vh] justify-center  ">
           ...
           <Link to={"/user.nobat.ir/signup"} className=" mt-[3rem] mx-auto bg-[#cccc] flex items-center justify-center rounded-[4px] w-[7rem] text-[#ffff] h-[2.3rem] pb-[.4rem]"> ساخت حساب</Link>
        </form>
    </section>
  )
}
