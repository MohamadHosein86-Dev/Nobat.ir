...
export default function PageDotor() {
    ...
    function handleOpenMenuNobat() {
      if(!authenticatd){
        return null
      }
    }

    const toesterError = toast.error("لطفا اول ثبت نام یا ورود کنید");
                     ...
                     <Modal>
                        <Modal.Open openwindowName="s">
                         <div className=" relative">
                            ...
                            <button onClick={handleOpenMenuNobat} style={{minWidth: "7rem"}} key={res.day} 
                       ...
                       {isTodayAcsepting?.includes(res.day) && authenticatd ?   <Modal.Window name="s">
                            <MoalGetNobat isTodayAcsepting={ res.day }  time_slots={ res.time_slots } />
                        </Modal.Window> : toesterError}
                     </Modal>
                    )}
                  </div>
            </div>
