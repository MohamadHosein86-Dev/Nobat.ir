...
export default function Home() {
  ...
  const totalPages = Math.ceil(( doctors?.length || 0 ) / pageSize);
     ...
     <div className="  max-w-[68rem] mx-auto  px-[1.5rem] py-[1rem] md:px-[4rem] md:py-[2rem]">
       ...
       <div>
            {Array.from({length : totalPages} , (__ , index)=>(
                ...
                <button className=" text-[.85ren] rounded-[50%] w-[2rem] h-[2rem] text-black custom_shadow3 bg-[#fff] flex justify-center items-center" onClick={()=>{}} key={index +1}>
                  {index+1}
                </button>
