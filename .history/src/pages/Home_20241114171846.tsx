       ...
       <div className=" w-[100%] flex  md:gap-[2.8rem]  ">
           ...
           <div className=" w-full flex flex-col">
                 ...
                 <ul className=" w-full flex flex-wrap gap-[1rem]">{doctors?.map((res)=>
                   <li onClick={()=>navigate("/")}  className=" cursor-pointer w-[100%] xl:w-[22rem] border-b-[1px] border-b-[#ececec] md:border-[1px] md:border-solid md:border-[#ececec] rounded-[.25rem] flex flex-col justify-between  px-[1rem] py-[.5rem] h-[11.5rem]" key={res.id}>
