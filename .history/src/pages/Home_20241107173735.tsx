       ...
       <div className=" w-[100%] flex gap-[2.8rem] ">
           <div>
              <ul className=" mr-[1.2rem] w-[11rem]">
                {specialties.map((res)=> <li key={res} className=" font-semibold text-[.8rem] cursor-pointer hover:text-[#363636] list-disc mb-[.8rem] text-[#363636ab] hover:font-semibold">{res}</li>)}
              </ul>
           </div>
           <div>
