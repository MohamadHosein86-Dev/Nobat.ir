                     ...
                     <Modal>
                        <Modal.Open openwindowName="s">
                         <div className=" relative">
                            {!isTodayAcsepting?.includes(res.day) && <span className=" flex justify-center bg-[red] text-[#fff] absolute w-[7rem] pr-[1.5rem] text-[.6rem] p-[.4rem]  font-bold rounded-[.5rem] ">نوبت دهی ندارد</span>}  
