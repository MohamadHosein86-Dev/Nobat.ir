  ...
  return (
    <section className=" w-full">
     <div className="  max-w-[68rem] mx-auto  px-[1.5rem] py-[1rem] md:px-[4rem] md:py-[2rem]">
           ...
           <div className=" w-full flex flex-col">
                 ...
                 <ul className=" w-full flex flex-wrap gap-[1rem]">{doctors?.map((res)=>
                    ...
                    <div className=" flex justify-between ">
                      ...
                      <div className=" flex justify-between items-center mb-[.5rem]">
                        ...
                        <div className="  flex items-center">
                           <span className=" gap-[1rem] text-[.7rem] text-[#878787] font-semibold">120 نفر </span>
                ...
                )}</ul>
                  {
                     ...
                     <button onClick={()=>handlePaginationLi("page",index+1)} key={index +1} className=" text-[.85ren] rounded-[50%] w-[2rem] h-[2rem] text-black custom_shadow3 bg-[#fff] flex justify-center items-center" >
                        {index+1}
                     </button>
                       ))}
                     </div>
       ...
       <LinkFooter titel="پرسش و پاسخ" handleLink={()=>handleLinkFooter()} />
