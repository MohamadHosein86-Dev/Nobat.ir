                       ...
                       <div className=" flex flex-col">
                        <div>
                          <h2 className=" text-lg font-semibold pt-[.5rem]">{res.name}</h2>
                           ...
                           {res.accepting_patients && <> <span className=" text-[.7rem] font-semibold text-[#bababa] ml-[.2rem]">نوبت دهی  </span> <span className=" rounded-[4px] p-[.2rem] text-[.7rem] font-semibold bg-[#75950c15]   text-[#75950c85]"> اینترنتی</span></>}
                        </div>
