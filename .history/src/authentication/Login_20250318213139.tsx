  ...
  return (
    <section className=" flex justify-center  w-[100%] h-[100%]">
        <form onSubmit={handleLogin} className=" flex flex-col w-[20rem] h-[100vh] justify-center  ">
                ...
                <button type="submit" className={` ${isfull && " bg-blue-400 "} mt-[.8rem] mx-auto bg-[#cccc] flex justify-center items-center rounded-[4px] w-[4.5rem] text-[#ffff] h-[2.3rem] `}>{titelBtn}</button>
