  ...
  return (
    <section className=" flex justify-center  w-[100%] h-[100%]">
        <form onSubmit={handleLogin} className=" flex flex-col w-full h-[100vh] justify-center  ">
                 ...
                 <input onChange={(x)=>setEmail(x.target.value)} placeholder=" jack@example.com..." className=" w-[25%] mx-auto  font-bold text-[black] border-[1px] border-[#dddd] pr-[.8rem] pb-[.5rem] h-[3rem] mb-[1.5rem] outline-none" type="email" id="10" />
                 ...
                 <input onChange={(x)=>setPassword(x.target.value)}  minLength={3} maxLength={8} placeholder="password..." className=" w-[25%] mx-auto font-bold text-[black] border-[1px] border-[#dddd] pr-[.8rem] pb-[.5rem] h-[3rem] mb-[2rem] outline-none" type="password" id="12" />
