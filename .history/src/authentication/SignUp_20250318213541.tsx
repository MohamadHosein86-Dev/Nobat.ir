  ...
  return (
    <section className=" flex justify-center px-[1.5rem] w-[100%] h-[100%]">
        <form onSubmit={handleLogin} className=" flex flex-col max-w-[20rem] h-[100vh] justify-center  ">
             ...
             <input onChange={(x)=>setEmail(x.target.value)} id="11"  placeholder=" jack@example.com..." className=" font-bold text-[black] border-[1px] w-[80%] border-[#dddd] pr-[.8rem] pb-[.5rem] h-[3rem] mb-[1rem] outline-none" type="email" value={email}  />
