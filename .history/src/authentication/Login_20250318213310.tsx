  ...
  return (
    <section className=" flex justify-center  w-[100%] h-[100%]">
        <form onSubmit={handleLogin} className=" flex flex-col w-[20rem] h-[100vh] justify-center  ">
                ...
                <button type="submit" className={` ${isfull ? " bg-blue-400 " : " bg-[#cccc] "} mt-[.8rem] mx-auto  flex justify-center items-center rounded-[4px] w-[4.5rem] text-[#ffff] h-[2.3rem] `}>{titelBtn}</button>
                <Link to={"/user.nobat.ir/signup"} className=" mt-[3rem] mx-auto bg-[#cccc] flex hover:bg-blue-400  items-center justify-center rounded-[4px] w-[7rem] text-[#ffff] h-[2.3rem] pb-[.3rem]"> ساخت حساب</Link>
