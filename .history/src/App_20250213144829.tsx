...
import ProtectedRoutedLogin from "./ui/ProtectedRoutedLogin";
...
const router = createBrowserRouter([
  {path:"/user.nobat.ir/login" , element:<ProtectedRoutedLogin> <Login/> </ProtectedRoutedLogin>},
  {path:"/user.nobat.ir/signup" , element:<ProtectedRoutedLogin> <SignUp/> </ProtectedRoutedLogin> },
