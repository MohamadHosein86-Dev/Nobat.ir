...
export default function MoalGetNobat({dayNobat , time_slots , isTodayAcsepting }:typeInput) {
    ...
    const isToday= today.Today === dayNobat;
    const now = new Date();
    const currentTime = now.getHours() * 60 + now.getMinutes();
    const nobatDay = isTodayAcsepting?.includes(dayNobat) ;
    // Date
