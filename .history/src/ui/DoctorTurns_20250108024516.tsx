    ...
    <section>
        ...
        <div className=" flex flex-col  w-[100%] ">
          {NobatDoctors.map((resp)=>{
             return(
                <div  className={` flex gap-[2rem] cursor-pointer pb-[1.2rem] border-b-[1px]  w-[100%] `}  >
                   <div onClick={()=>setShowFulNobat((res)=>res!)}  className=" flex justify-between items-center  w-[100%] mt-[1.2rem] ">
