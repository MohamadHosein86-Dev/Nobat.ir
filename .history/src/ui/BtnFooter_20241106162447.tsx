...
export default function BtnFooter( {children , onclick} :typeBtnLogin) {
    ...
    return (
      <Link to="/" onClick={onclick} className="  font-light  md:w-[27rem] w-[100%] h-[2.5rem] border-[1px] border-stone-300 flex justify-center items-center rounded-[6px]  bg-footer-500">
