...
export default function DoctorTurns() {
  ...
  (); const [showFulNobat, setShowFulNobat] = useState(Array(NobatDoctors.length).fill(false));
   const handleClick = (index) => { const newShowFulNobat = [...showFulNobat]; newShowFulNobat[index] = !newShowFulNobat[index]; setShowFulNobat(newShowFulNobat);
    ...
    <section>
        ...
        <div className=" flex flex-col  w-[100%] ">
          {NobatDoctors.map((resp , index)=>{         
            ...
            return(
                <div onClick={()=>setShowFulNobat(true)} className={` ${showFulNobat && "hidden"} flex gap-[2rem] cursor-pointer pb-[1.2rem] border-b-[1px]  w-[100%] `}  >
