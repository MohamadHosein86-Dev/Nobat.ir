...
export default function PageDotor() {
    ...
    const phone = showphone ? doctor?.phone
       ...
       <div className="flex-col lg:flex-row flex justify-between  ">
            <div className=" ">
                  <div className=" flex gap-[1.5rem] overflow-x-auto mt-[1rem] justify-center">
                    {!doctor?.accepting_patients ? <h2 className=" text-[2rem] font-medium text-center text-[red]">نوبت دهی اینترنتی ندارد!</h2> : doctor?.working_hours.map((res)=>(<div style={{minWidth: "7rem"}} key={res.day} className=" flex flex-col justify-center font-semibold items-center border-[1px] rounded-[10px] border-[#75950c] text-[#75950c] w-[7rem] h-[7.5rem] bg-[#f9ffea]">
                      {res.day}
            ...
            <div className="">
                ...
                <div className=" flex items-end flex-col w-[100%]">
                  <div className=" mt-[1.5rem] flex justify-center gap-[.4rem] items-center  w-[12rem] px-[.4rem] py-[.5rem] bg-[#fbfbfb]">
                    <span className=" font-medium text-[1.3rem]"></span>
                    <span >
                  ...
                  <div className=" w-[100%] flex gap-[1rem] mt-[1rem]">
                    <button className=" text-[#fafafa] bg-[#88b200] w-[50%] lg:w-[12.5rem] px-[.4rem]  pb-[.3rem] h-[3rem] sm:h-[2.5rem] lg:h-[]" >دریافت نوبت اینترنتی</button>
                    <button className={` ${showphone && "hidden"} text-[#363636] w-[50%] lg:w-[12.5rem] px-[.4rem]   pb-[.3rem] sm:h-[2.5rem] h-[3rem lg:h-[] bg-[#efefef] `}>نمایش کامل تلفن</button>
                  </div>
                </div>
            </div>
       </div>
