...
export default function DoctorTurns() {
  ...
  function handleIsAcsepting(name:string) {
        const doctor= NobatDoctors.find((res)=> res.name === name ? res : "" );
        ...
        const fromTimeIsPassed =  currentTime > slotTime ? false :true;
    

        console.log(currentTime , slotTime , nobatDay , currentDay ,fromTimeIsPassed);
