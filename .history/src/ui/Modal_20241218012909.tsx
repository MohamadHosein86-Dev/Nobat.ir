...
function Window({children , name }:tyepep) {
    ...
    const style2 = "fixed right-0 top-1/2 transform -translate-y-1/2 bg-white p-5 shadow-md z-[1000] md:top-1/2 md:rounded-none sm:top-full md:w-full sm:rounded-2xl";
    ...
    return createPortal (
       <Overlay>
          <StyledModal className={`${pathname === "/user.nobat.ir/favarite" ?style2 : style2} `} ref={modalRef}>
            <div>
