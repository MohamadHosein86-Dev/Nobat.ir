            ...
            <div className="">
                ...
                <div className=" flex items-end flex-col w-[100%]">
                  ...
                  <div className=" w-[100%] flex gap-[1rem] mt-[1rem]">
                    <button className=" text-[#fafafa] bg-[#88b200] w-[50%] lg:w-[12.5rem] px-[.4rem] pb-[.4rem] pt-[.2rem]" >دریافت نوبت اینترنتی</button>
                    <button className=" text-[#363636] w-[50%] lg:w-[12.5rem] px-[.4rem] pb-[.4rem] pt-[.2rem]  bg-[#efefef] ">نمایش کامل تلفن</button>
                  </div>
                </div>
            </div>
       </div>
