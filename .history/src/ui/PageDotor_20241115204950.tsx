    ...
    <div className="flex justify-between  ">
            <div>
                  <div className=" flex gap-[2rem] overflow-x-auto">
                    {doctor?.working_hours.map((res)=>(<div className=" flex justify-center font-semibold items-center border-[1px] rounded-[5px] border-[#75950c] text-[#75950c] w-[7rem] h-[6rem] bg-[#f9ffea]">{res.day}</div>))}
                  </div>
            </div>
            <div className="">
