...
function Window({children , name }:tyepep) {
    ...
    const style2 = " flex justify-center items-center jus bg-white p-5 shadow-md z-[1000] md:top-1/2 md:rounded-none sm:top-full sm:w-full sm:rounded-2xl";
    ...
    return createPortal (
       <Overlay>
          <div className={`${pathname === "/user.nobat.ir/favarite" ?style2 : style1} `} ref={modalRef}>
            <div>
