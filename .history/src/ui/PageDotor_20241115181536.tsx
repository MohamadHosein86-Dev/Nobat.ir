            ...
            <div className="">
                ...
                <div className=" flex items-end flex-col">
                  ...
                  <div className=" flex gap-[1rem] mt-[1rem]">
                    <button className=" text-[#fafafa] bg-[#88b200]  w-[13rem] px-[.4rem] pb-[.6rem] pt-[.3rem]" >دریافت نوبت دهی اینترنتی</button>
                    <button className=" text-[#363636] w-[13rem] px-[.4rem] pb-[.6rem] pt-[.3rem]  bg-[#efefef] ">نمایش کامل تلفن</button>
                  </div>
                </div>
            </div>
       </div>
