...
export default function Footer() {
  ...
  return (
    <section className=" w-[100%] mt-[2rem]  bg-footer-500  pb-[2rem]">
       <div className=" w-full bg-[#e5f9ff] pb-[1.3rem] pt-[1.3rem]">
          <div className=" max-w-[68rem]  mx-auto  px-[1.5rem]   ">
          <Link to={""} className={` pb-[.4rem]  custom_shadow2  text-[#598a98] font-sans ${ pathname == "/" ? "w-[100%]" : "w-[50%]" } h-[2.3rem]  flex justify-center items-center rounded-[6px]  bg-[#fafafa]" to={""} `}>
