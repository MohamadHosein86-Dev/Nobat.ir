...
export default function PhoneModal({phone}:typeInput) {
  ...
  return (
    <div className=' w-[26rem] relative  h-[6rem]  '>
        <div className=" absolute bg-[#efefef] w-[2rem] h-[2rem] rounded-[50%] "></div>
        <div className=" border-b left-[.5rem]  border-b-[#000000a6] flex flex-col ">
