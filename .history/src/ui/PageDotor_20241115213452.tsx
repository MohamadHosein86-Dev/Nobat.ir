    ...
    <section className="">
      ...
      <div className="  max-w-[68rem] mx-auto  px-[1.5rem]  py-[1rem] flex-col   md:px-[4rem] md:py-[2rem]">
       ...
       <div className="flex-col lg:flex-row flex justify-between  ">
            <div className="  w-[100%] ">
                  <div className=" lg:w-[44%] w-[100%] flex gap-[2rem] overflow-auto mt-[1rem] lg:mx-[0] mx-auto">
                    {doctor?.working_hours.map((res)=>(<div className=" flex flex-col justify-center font-semibold items-center border-[1px] rounded-[10px] border-[#75950c] text-[#75950c] w-[7rem] h-[7.5rem] bg-[#f9ffea]">
                      {res.day}
            ...
            <div className="">
                ...
                <div className=" flex items-end flex-col">
                  ...
                  <div className=" flex gap-[1rem] mt-[1rem]">
                    <button className=" text-[#fafafa] bg-[#88b200]  w-[12.5rem] px-[.4rem] pb-[.4rem] pt-[.2rem]" >دریافت نوبت اینترنتی</button>
                    <button className=" text-[#363636] w-[12.5rem] px-[.4rem] pb-[.4rem] pt-[.2rem]  bg-[#efefef] ">نمایش کامل تلفن</button>
                  </div>
                </div>
            </div>
       </div>
