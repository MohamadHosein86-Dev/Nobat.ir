...
export default function PageDotor() {
   ...
   const delWord =doctor?.address ? doctor?.address.split(" ") : "";
   const matab = delWord[2].replace("," , "");
      ...
      <div>
       ...
       <div className=" flex flex-col">
        ...
        <div className=" flex gap-[1rem]">
         ...
         <div className="max-w-[68rem]  px-[1.5rem]  py-[1rem] flex  md:px-[4rem] md:py-[2rem]">
            <div className="">
                <h3 className="bg-[#f8feff]  text-[#004d6c] font-medium mt-[1rem]  w-[12rem]" >  مطب {matab}</h3>
            </div>
            <div>
