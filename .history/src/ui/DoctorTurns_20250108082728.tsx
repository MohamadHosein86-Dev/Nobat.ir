            ...
            <div key={index}>
              ...
              (
                <div onClick={() => handleClick(index)}>
                      <div className=" relative flex justify-center items-center rounded-[1.3rem] border-[#ffff] border-[4px] custom_shadow6 mt-[-1rem] w-[100%] bg-[#f9f9f9] h-[18rem]">
                          <div className=" flex flex-col w-[100%]">
                            ...
                            <div className=" flex flex-col gap-[2px] w-[100%] px-[4rem]">
                               <div className=" bg-[#ffff] w-[100%] px-[.5rem] py-[.5rem] flex items-center justify-between">
                               ...
                               <div className=" bg-[#ffff] w-[100%] px-[.5rem] py-[.5rem] flex items-center justify-between">
                                  ...
                                  <p className=" text-sm font-bold text-[#000000a6]">{resp.nobatDay}</p>
                               </div>
                            </div>
                            <div></div>  
                          </div>
