...
export default function PageDotor() {
   ...
   const matab = delWord[2];
    ...
    <>
      ...
      <section className=" max-w-[68rem]  px-[1.5rem]  py-[1rem] flex gap-[10rem]  md:px-[4rem] md:py-[2rem]">
      <div>
       
       <div className=" flex flex-col">
         <div className=" max-w-[68rem]  px-[1.5rem]  py-[1rem] flex-col   md:px-[4rem] md:py-[2rem]">
        <div className=" flex gap-[1rem]">
         ...
         <div className="max-w-[68rem]  px-[1.5rem]  py-[1rem] flex gap-[10rem]  md:px-[4rem] md:py-[2rem]">
            <div>
                  sss
            </div>
            <div className="">
                <h3 className="bg-[#dff9ff]  text-[#004d6c] h-[2rem] font-medium mt-[1rem]  w-[10rem]" >  مطب {matab}</h3>
            </div>
         </div>
