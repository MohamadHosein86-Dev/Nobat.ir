  ...
  return (
    <div className=' w-[26rem]  h-[6rem]  '>
        ...
        <div className=" border-b  border-b-[#000000a6] flex flex-col ">
            ...
            <div className=" flex items-center mt-[1rem] justify-between   pb-[.5rem] w-[100%]  hover:text ">
              <button className=" flex items-center bg-[#efefef] border-none rounded-[50%]  justify-center w-[2.5rem] text-[#000] text-[1.5rem] h-[2.5rem]  custom_shadow8">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height=".7em" width=".7em" xmlns="http://www.w3.org/2000/svg">
