...
export default function PhoneModal({phone , CloseModal}:typeInput , kir) {
  console.log(CloseModal+"Sddd");
    ...
    <div className=' w-[26rem]   h-[6rem]  '>
        <div className=" border-b   border-b-[#000000a6] flex flex-col ">
            <div className=" flex justify-between w-[100%]">
              ...
              <div className=" flex justify-center cursor-pointer items-center  bg-[#efefef] w-[2rem] h-[2rem] rounded-[50%] ">
