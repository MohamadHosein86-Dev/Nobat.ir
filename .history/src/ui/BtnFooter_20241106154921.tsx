...
export default function BtnFooter( {children , onclick} :typeBtnLogin) {
    ...
    return (
      <Link to="/" onClick={onclick} className="  font-light  md:w-[29rem] w-[100%] h-[3rem] border-[1px] border-stone-400 flex justify-center items-center rounded-[6px] bg-btnLogin-200">
