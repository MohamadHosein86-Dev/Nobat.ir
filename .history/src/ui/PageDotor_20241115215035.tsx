    ...
    <section className="">
      ...
      <div className="  max-w-[68rem] mx-auto  px-[1.5rem]  py-[1rem] flex-col   md:px-[4rem] md:py-[2rem]">
       ...
       <div className="flex-col lg:flex-row flex justify-between  ">
            <div className=" ">
                  <div className=" w-[100%] flex gap-[2rem] overflow-hidden mt-[1rem] ">
                    {doctor?.working_hours.map((res)=>(<div className="lg:mx-[] mx-auto flex flex-col justify-center font-semibold items-center border-[1px] rounded-[10px] border-[#75950c] text-[#75950c] w-[7rem] h-[7.5rem] bg-[#f9ffea]">
                      {res.day}
                      <> {res.time_slots.map((item)=> (<p className=" text-[.8rem] mt-[.5rem]">از {item.from} تا {item.to}</p>))}</>
                      </div>))}
                  </div>
            </div>
            <div className="">
                <h3 className="bg-[#dff9ff]  text-[#004d6c] pt-[.4rem] pb-[.8rem] pr-[1.2rem] font-medium mt-[1rem] w-[100%] xl:w-[27rem]" >  مطب {matab}</h3>
                ...
                <div className=" flex items-end flex-col w-[100%]">
                  ...
                  <div className=" w-[100%] flex gap-[1rem] mt-[1rem]">
                    <button className=" flex justify-center items-center text-[#fafafa] bg-[#88b200] w-[100%]  lg:w-[12.5rem] px-[.4rem] h-[2rem]" >دریافت نوبت اینترنتی</button>
                    <button className=" flex justify-center items-center text-[#363636] w-[100%] lg:w-[12.5rem]  px-[.4rem]  bg-[#efefef] h-[2rem]">نمایش کامل تلفن</button>
                  </div>
                </div>
            </div>
       </div>
