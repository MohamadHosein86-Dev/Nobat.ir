...
export default function Footer() {
  ...
  return (
    <section className=" w-[100%]  bg-footer-500  pb-[2rem]">
       <div className=" bg-[#e5f9ff] w-[100%] h-[4rem] py-[1rem]">
        <Link className="custom_shadow1 text-[#fff] font-light  lg:w-[100%] w-[22rem] h-[2.7rem]  flex justify-center items-center rounded-[6px]  bg-footer-500" to={""}></Link>
       </div> 
