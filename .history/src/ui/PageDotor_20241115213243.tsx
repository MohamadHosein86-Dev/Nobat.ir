    ...
    <section className="">
      ...
      <div className="  max-w-[68rem] mx-auto  px-[1.5rem]  py-[1rem] flex-col   md:px-[4rem] md:py-[2rem]">
       ...
       <div className="flex-col lg:flex-row flex justify-between  ">
            <div className="  w-[100%] ">
                  <div className=" w-[100%] flex gap-[1.5rem] overflow-auto mt-[1rem] ">
                    {doctor?.working_hours.map((res)=>(<div className=" xl:mx-[0] mx-auto flex flex-col justify-center font-semibold items-center border-[1px] rounded-[10px] border-[#75950c] text-[#75950c] w-[7rem] h-[7.5rem] bg-[#f9ffea]">
                      {res.day}
