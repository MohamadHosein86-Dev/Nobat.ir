...
export default function Footer() {
  ...
  return (
    <section className=" w-[100%]  bg-footer-500  pb-[2rem]">
       <div className=" w-full bg-[#e5f9ff]">
          <div className=" max-w-[68rem] pt-[1.8rem] mx-auto mt-[1rem] px-[1.5rem] ]  md:pt-[2rem]">
          <Link className="custom_shadow2  text-[#fff] font-light  lg:w-[100%] w-[22rem] h-[2rem]  flex justify-center items-center rounded-[6px]  bg-[#fafafa]" to={""}>
            {pathname == "/" && "پرسش و پاسخ"}
          </Link>
          </div>
       </div> 
       <footer className=" max-w-[68rem] pt-[1.8rem] mx-auto mt-[2rem] px-[1.5rem] ]  md:pt-[2rem] flex justify-center">
          <div className=" w-[100%] ">
