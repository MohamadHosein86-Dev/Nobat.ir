...
export default function PageDotor() {
   ...
   const cityAdress = city[0];
    ...
    <div className="flex justify-between items-center ">
            ...
            <div className="">
                <h3 className="bg-[#dff9ff]  text-[#004d6c] pt-[.4rem] pb-[1rem] pr-[1.2rem] font-medium mt-[1rem]  w-[27rem]" >  مطب {matab}</h3>
                <div className=" flex justify-center items-center w-[3rem] h-[2.5rem] bg-[#f4f4f4] my-[1rem]">
                  <p>{cityAdress}</p>
                </div>
            </div>
       </div>
