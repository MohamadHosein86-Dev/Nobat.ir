    ...
    <div className="flex justify-between items-center ">
            ...
            <div className="">
                ...
                <div className=" flex items-end flex-col">
                  <button className=" mt-[1.5rem] flex justify-center gap-[.4rem] items-center  w-[12rem] px-[.4rem] py-[.6rem] bg-[#fbfbfb]">
                  ...
                  <div className=" flex gap-[1rem] mt-[1rem]">
                    <button>دریافت نوبت دهی اینترنتی</button>
                    <button className=" text-[#363636] w-[13rem] px-[.4rem] pb-[.4rem] pt-[.4rem]  bg-[#efefef] ">نمایش کامل تلفن</button>
                  </div>
                </div>
            </div>
       </div>
