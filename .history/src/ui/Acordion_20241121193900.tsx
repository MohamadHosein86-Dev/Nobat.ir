...
export default function Acordion({titel , contect ,contentTitle , listItems}:Acordiontype) {
 const [showContent,setShowContent]=useState(false);
  ...
  return (
    <div className=" mb-[3rem] w-[100%] border-b-[1px] border-b-[#ddd] border-solid pb-[.5rem]">
        <div className=" flex w-[100$] justify-between">
            <h2 className=" font-bold">{titel}</h2>
            <button className="pb-[.2rem] bg-[#efefef] flex items-center justify-center text-2xl w-[2.5rem] h-[2.5rem] rounded-full">+</button>
        </div>
        {showContent && 
