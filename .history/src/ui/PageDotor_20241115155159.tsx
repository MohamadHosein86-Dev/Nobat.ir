    ...
    <div className="flex justify-between items-center ">
            ...
            <div className="">
                ...
                <div className=" flex justify-end">
                  <button className=" flex justify-center gap-[.4rem] items-center  w-[12rem] px-[.4rem] py-[.4rem] bg-[#fbfbfb]">
                    <span className=" font-medium text-[1.4rem]">{doctor?.phone}</span>
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="#ddd" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
