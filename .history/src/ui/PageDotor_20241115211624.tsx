    ...
    <div className="flex justify-between  ">
            <div>
                  <div className=" flex gap-[2rem] overflow-auto">
                    {doctor?.working_hours.map((res)=>(<div className=" flex flex-col justify-center font-semibold items-center border-[1px] rounded-[10px] border-[#75950c] text-[#75950c] w-[6.5rem] h-[7rem] bg-[#f9ffea]">
                      {res.day}
