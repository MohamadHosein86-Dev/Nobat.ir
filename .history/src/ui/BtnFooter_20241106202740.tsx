...
export default function BtnFooter( {children , onclick} :typeBtnLogin) {
    ...
    return (
      <Link to="/" onClick={onclick} className="custom_shadow1 mx-[2rem]  font-light  md:w-[27rem] w-[100%] h-[2.7rem]  flex justify-center items-center rounded-[6px]  bg-footer-500">
