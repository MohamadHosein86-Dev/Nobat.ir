...
export default function DoctorTurns() {
  ...
  if(NobatDoctors.length !== 0)return (
              ...
              (
                <div>
                      <div className=" py-[3rem] relative flex justify-center items-center rounded-[1.3rem] border-[#ffff] border-[4px] custom_shadow6 mt-[-1rem] w-[100%] bg-[#f9f9f9] h-[26rem]">
                          ...
                          <button  className=" rounded-2xl flex justify-center items-center p-[.5rem] bg-[red] absolute top-[1rem] left-[1rem]" onClick={()=>{dispatch(delefNobatDoctors(resp.id)); console.log("kdlccaaa");
                          }}>
                              <span className=" text-[#fff]">حذف این نوبت</span>
                          </button>
                      </div>
                </div>
              )
    ...
    <div className="max-w-[54rem] flex flex-col gap-[2rem] px-[1.5rem] mx-auto py-[1rem]  md:px-[4rem] md:pt-[1.5rem] md:pb-[1.5rem">
      <div className=" w-[100%] flex justify-center items-center gap-[1rem]">
              <span className=" w-[100%] bg-[#cdcdcd] h-[1px]"></span>
              <div className=" w-[38.3%] text-[#cdcdcd]"> لیست نوبت های من  </div>
              <span className=" w-[100%] bg-[#cdcdcd] h-[1px]"></span>
           </div>
          <div className="  flex flex-col justify-center items-center w-[100%] text-center ">
              ...
              <h2 className=" font-medium text-[#6c757d65] ">پزشکی در لیست علاقه مندی های شما وجود ندارد</h2>
          </div>
    </div>
  )
}