...
export default function Footer() {
  ...
  return (
    <section className=" w-[100%]  bg-footer-500  h-[26rem]">

       <footer className=" max-w-[68rem] mx-auto mt-[10rem] px-[1.5rem] py-[1rem] md:px-[4rem] md:py-[2rem] flex justify-center">
          <div className=" w-[100%]">
              ...
              <div className=" flex gap-[1rem] items-center justify-end mt-[2.2rem] ">
                  <a href="" className=" bg-[#fff] px-[.9rem] py-[1rem] rounded-md flex-grow flex justify-center items-center">
                    <img className="w-[4.8rem] text-center" src="https://trustseal.enamad.ir/Content/Images/Star2/81.png?v=5.0.0.3777" alt="" />
                 </a>
                  <a href="" className=" bg-[#fff] px-[1.2rem] py-[1.2rem] rounded-md flex-grow flex justify-center items-center ">
                       <img className=" w-[4.2rem] text-center" src="https://nobat.ir/public/ui_v2_0/images/uiv2/ecunion.png" alt="" />
                  </a>
                 <a href="" className=" bg-[#fff] px-[1.2rem] py-[1rem] rounded-[7px] flex-grow flex justify-center items-center">
