       ...
       <div className="flex-col lg:flex-row flex justify-between  ">
            <div className=" ">
                  <div className=" flex gap-[1.5rem] overflow-x-auto mt-[1rem] justify-center">
                    {!doctor?.accepting_patients ? <h2>نوبت دهی تلفنی</h2> : doctor?.working_hours.map((res)=>(<div style={{minWidth: "7rem"}} key={res.day} className=" flex flex-col justify-center font-semibold items-center border-[1px] rounded-[10px] border-[#75950c] text-[#75950c] w-[7rem] h-[7.5rem] bg-[#f9ffea]">
                      {res.day}
