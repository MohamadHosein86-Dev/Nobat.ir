       ...
       <div className="flex-col lg:flex-row flex justify-between  ">
            <div className="  w-[100%] ">
                  <div className=" w-[100%] flex gap-[2rem] overflow-auto mt-[1rem] ">
                    {doctor?.working_hours.map((res)=>(<div className=" xl:mx-[] mx-auto flex flex-col justify-center font-semibold items-center border-[1px] rounded-[10px] border-[#75950c] text-[#75950c] w-[7rem] h-[7.5rem] bg-[#f9ffea]">
                      {res.day}
