...
export default function BtnFooter( {children , onclick} :typeBtnLogin) {
    ...
    return (
      <Link to="/" onClick={onclick} className="custom_shadow1  font-light  xl:w-[26rem] max-w-[40rem] h-[2.7rem]  flex justify-center items-center rounded-[6px]  bg-footer-500">
