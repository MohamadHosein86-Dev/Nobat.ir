...
export default function PageDotor() {
   ...
   const cityAdress = city[0];
    ...
    <div className="flex justify-between  ">
            <div>
                  <div className=" flex gap-[.5rem] overflow-x-auto">
                    {doctor?.working_hours.map((res)=>(<div className=" border-[1px] rounded-[5px] border-[#75950c] text-[#75950c] w-[5.5rem] h-[5.5rem] bg-[#f9ffea]">{res.day}</div>))}
                  </div>
            </div>
            <div className="">
