...
export default function HedarProfaile() {
   ...
   const LinkFvaritDoctor = authenticatd && favaritDoctors &&
    <Link to={"/favarite"} className=" w-[50%] custom_shadow5 bg-[#fbfbfb] flex items-center justify-center rounded-[1.1rem] flex-col-reverse p-[.5rem] ">
