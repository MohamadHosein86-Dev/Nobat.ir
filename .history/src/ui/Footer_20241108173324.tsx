...
export default function Footer() {
  ...
  return (
    <section className=" w-[100%]  bg-footer-500  h-[25rem]">

       <footer className=" max-w-[68rem] mx-auto mt-[20rem] px-[1.5rem] pt-[1rem]  md:pt-[2rem] flex justify-center">
          <div className=" w-[100%] ">
             ...
             {pathname === "/" &&
               <div className=" flex gap-[1rem] items-center justify-end my-[2.2rem] ">
