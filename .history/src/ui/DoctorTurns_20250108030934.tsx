...
export default function DoctorTurns() {
  ...
  const {user}=useUser();
   ...
   const [showFulNobat, setShowFulNobat] = useState<number | null>(null);
    ...
    <section>
        ...
        <div className=" flex flex-col  w-[100%] ">
          {NobatDoctors.map((resp , index)=>{         
            ...
            return(
                <div onClick={()=>setShowFulNobat(index)} className={` ${showFulNobat === index && "hidden"} flex gap-[2rem] cursor-pointer pb-[1.2rem] border-b-[1px]  w-[100%] `}  >
