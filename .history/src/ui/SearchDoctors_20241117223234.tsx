...
*/
  ...
  return (
    <div className="  max-w-[68rem] mx-auto  px-[1.5rem]  py-[1rem] md:px-[4rem] md:py-[2rem]">
      {specialties.includes(search) && <button className="w-[22rem] h-[3.2rem] text-[#ffff] bg-[#0092ab] border-[#fff] rounded-[9px] border-[1px] custom_shadow4 text-[.95rem] flex items-center justify-center " onClick={()=>{}}>{search}</button>  }
