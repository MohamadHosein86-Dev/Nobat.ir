...
export default function ShowPhone({phone}:typePhone) {
  ...
  return (
    ...
    <div className=" w-[100%] flex gap-[1rem] mt-[1rem]">
      <button onClick={hanleShowPhone} className={` pt-[.2rem] flex items-center justify-center ${showphone && "hidden"} text-[#363636] w-[100%] lg:w-[12.5rem] px-[.4rem]   pb-[.3rem] sm:h-[2.5rem] h-[3rem lg:h-[] bg-[#efefef] `}>
