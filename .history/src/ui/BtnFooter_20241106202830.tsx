...
export default function BtnFooter( {children , onclick} :typeBtnLogin) {
    ...
    return (
      <Link to="/" onClick={onclick} className="custom_shadow1 mx-[0rem]  font-light  md:w-[26rem] w-[100%] h-[2.7rem]  flex justify-center items-center rounded-[6px]  bg-footer-500">
