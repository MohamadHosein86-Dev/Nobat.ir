...
export default function PhoneModal({phone , CloseModal}:typeInput ) {
  ...
  return (
    <div className=' w-[26rem]   h-[6rem]  '>
        <div className=" border-b pb-[.2rem]   border-b-[#000000a6] flex flex-col ">
            ...
            <div className=" hover:text-[#40a9ff] transition-all ease-in delay-75 cursor-pointer  flex items-center mt-[1.5rem] justify-between   pb-[.5rem] w-[100%]  hover:text ">
