...
export default function Acordion({titel , contect ,contentTitle , listItems}:Acordiontype) {
 ...
 const isTitel = titel.includes("قوانین ثبت آگهی و خدمات نرم افزار نوبت دهی مطب ها در «نوبت دات آی آر» چیست؟");
  return (
    <div className=" mb-[1rem] w-[100%] border-b-[1px] border-b-[#ddd] border-solid pb-[1rem]">
        <div className="flex w-[100$]  lg:flex-row flex-col  justify-between">
            <h2 className={` ${isTitel && " text-[1.5rem]"} font-bold `}>{titel}</h2>
